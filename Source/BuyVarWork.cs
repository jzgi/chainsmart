...
namespace Revital
{
    ...
    public abstract class BizlyBuyVarWork : BuyVarWork
    {
    }

    public class AgriBizlyBuyVarWork : BizlyBuyVarWork
    {
        [Ui, Tool(ButtonOpen)]
    ...
    public class DietBizlyBuyVarWork : BizlyBuyVarWork
    {
    }

    public abstract class CtrlyBuyVarWork : BuyVarWork
    {
    }

    public class CtrlyAgriBuyVarWork : CtrlyBuyVarWork
    {
    }

    public class DietCtrlyBuyVarWork : CtrlyBuyVarWork
    {
    }


    public class FrmlyBuyVarWork : BuyVarWork
    {
    }
}