        ...
        public async Task @default(WebContext wc)
        {
            ...
            if (wc.IsGet)
            {
                ...
                wc.GivePane(200, h =>
                {
                    ...
                    h.LI_().SELECT("供应级别", nameof(o.bookg), o.bookg, Product.Bookgs, required: true).SELECT("状态", nameof(o.status), o.status, Info.Statuses, filter: (k, v) => k > 0, required: true)._LI();
