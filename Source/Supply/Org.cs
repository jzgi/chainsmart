...
namespace Zhnt.Supply
{
    ...
    /// </summary>
    public class Org : _Art, IKeyable<short>
    {
        ...
        public bool IsShop => (typ & TYP_BASE) == TYP_BASE;

        public bool IsPt => (typ & TYP_PT) == TYP_PT;
        ...
        public static string GetAcct(short orgid)
        {
